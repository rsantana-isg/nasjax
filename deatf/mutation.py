...
from network import MIN_NUM_NEURONS, MIN_NUM_FILTERS, MIN_NUM_STRIDES, MIN_NUM_CHANNELS, MAX_NUM_CHANNELS
...
class Mutation:
    ...
    def apply_random_mutation(self):
        ...
        #print("Possible mutations are", possible_mutations)
...
class MLP_Mutation(Mutation):
    ...
    def mut_add_layer(self):
        ...
        #print("Add layer",new_layer_pos, new_lay_dims, new_init_function,  new_act_function, new_drop_prob)
    ...
    def mut_dimension(self):
        ...
        #print("dimensions",MIN_NUM_NEURONS, self.network.max_num_neurons)
        #print("n_hidden, layer_pos",self.network.number_hidden_layers,layer_pos)

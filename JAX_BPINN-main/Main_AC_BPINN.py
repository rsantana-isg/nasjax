...
from Main_BPINN_Functions.Aux_functions_Main_AC_BPINN import get_data, network_selection, define_sigma_likelihood, initialize_local_lambdas, initialize_global_lambdas, make_step_None, logs_init, update_logs, validation_step

project_name = "AllenCahn_Hidden_Layers_BPINN"
file_name = 'AllenCahn_BPINN_'
...
enhanced_MLP = 'N' # Possible options : 'Y'es,'N'o
...
data_root = './Main_BPINN_Functions/Data/AC.mat'
...
#         "sigma_bc_u": sigma_likelihood["SIGMA_bc_u"],
#         "sigma_bc_du_dx": sigma_likelihood["SIGMA_bc_du_dx"],
#         "prior_SnS_pi": sns_pi,
...
for epoch in range (N_EPOCHS):
        ...
        #       "log_lik_bc_u":loss_logs["log_lik_bc_u"],

        #       "log_lik_bc_du_dx":loss_logs["log_lik_bc_du_dx"],
        #       "unaltered_log_lik_pde": loss_logs["unaltered_log_lik_pde"],
        #       "unaltered_log_lik_ic": loss_logs["unaltered_log_lik_ic"],
        #       "unaltered_log_lik_bc_u": loss_logs["unaltered_log_lik_bc_u"],
        #       "unaltered_log_lik_bc_du_dx": loss_logs["unaltered_log_lik_bc_du_dx"],            
        ...
        #       "lambda_g_bc_u":global_lambdas["lambda_lik_bc_u"],
        #       "lambda_g_bc_du_dx":global_lambdas["lambda_lik_bc_du_dx"],
        ...
        #       "lambda_l_bc_u":jnp.mean(local_lambdas["lambda_bc_u"]),
        #       "lambda_l_bc_du_dx":jnp.mean(local_lambdas["lambda_bc_du_dx"]),
        # })
        ...
        #         activation_function = activation_function
        #         # bc_uoss_weight=np.array(bc_uoss_weight),

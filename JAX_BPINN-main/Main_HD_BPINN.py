...
from Main_BPINN_Functions.Aux_functions_Main_HD_BPINN import get_data, network_selection, define_sigma_likelihood, initialize_local_lambdas, initialize_global_lambdas, make_step_None, logs_init, update_logs, validation_step

project_name = "HeatDiffusion_Hidden_Layers_BPINN"
file_name = 'HeatDiffusion_BPINN_'
